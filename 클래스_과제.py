...
class Order:
    ...
    #     return int(self.cart.get_total_price() * 할인율)
 
    # def get_shipping_fee(self):
    #     discounted = self.cart.get_total_price() - self.get_discount_amount()
    #     if discounted >= 무료배송금액:
    #         return 0
    #     return 배송비
    ...
    def calculate_final_price(self):
        ...
        # """
        # shipping_fee = 3000
        # fianl_price = self.cart.get_total_price() + shipping_fee
